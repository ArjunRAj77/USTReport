/**
 * Contains the definition of the API endpoints for game packages
 */
...
module.exports = function (router) {
    ...
    // RETRIEVE all active game packages
...
var processValidationErrors = function (err) {
    ...
    //Check if rating of the package is missing
    if (err.errors.Rating) {
        if (err.errors.Rating.kind === apiErrors.kinds.REQUIRED) {
            errorList.push(apiErrors.errors.MISSING_RATING)
        }
    }
